...
const data = readFile('day_4_input.txt')
...
const numbers = data[0].split(',').map(x => +x)
const width = 5
const height = 5
const boards = []
...
const { board, number} = winners[winners.length - 1]
